    ...
    <div className="flex flex-col min-h-screen bg-gray-950 text-gray-100">
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-gray-800">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="font-bold text-purple-400">PartyQueue</span>
        </Link>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-400 md:text-xl">
                  Create music spaces, add songs, vote, and let the crowd decide the playlist. Perfect for parties,
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border border-gray-800 p-6 rounded-lg bg-gray-950">
                ...
                <p className="text-sm text-gray-400 text-center">
                  Set up unique music spaces for your events with custom settings.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border border-gray-800 p-6 rounded-lg bg-gray-950">
                ...
                <p className="text-sm text-gray-400 text-center">
                  Participants can easily add songs to the queue from various music services.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border border-gray-800 p-6 rounded-lg bg-gray-950">
                <ThumbsUp className="h-12 w-12 text-purple-400" />
                <h3 className="text-xl font-bold text-purple-400">Vote on Songs</h3>
                <p className="text-sm text-gray-400 text-center">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2">
              <div className="space-y-4 bg-gray-900 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-purple-400">For Creators</h3>
              ...
              <div className="space-y-4 bg-gray-900 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-purple-400">For Participants</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-gray-400 md:text-xl">
                  Join PartyQueue today and start creating collaborative music experiences for your events.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
                <Button className="w-full bg-purple-600 text-white hover:bg-purple-700">Get Started for Free</Button>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-gray-800">
        <p className="text-xs text-gray-400">© 2023 PartyQueue. All rights reserved.</p>
